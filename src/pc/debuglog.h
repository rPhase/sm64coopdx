...
#define LOG_ERROR(...)
#else
#define LOG_DEBUG(...) (configDebugPrint ? ( _debuglog_print_log("DEBUG", __FILE__), printfANDROID(__VA_ARGS__), printfANDROID("\n") ) : 0)
#define LOG_INFO(...)  (configDebugInfo  ? ( _debuglog_print_log("INFO",  __FILE__), printfANDROID(__VA_ARGS__), printfANDROID("\n") ) : 0)
#define LOG_ERROR(...) (configDebugError ? ( _debuglog_print_log("ERROR", __FILE__), printfANDROID(__VA_ARGS__), printfANDROID("\n") ) : 0)
#endif
