...
static const struct ConfigOption options[] = {
    ...
    {.name = "touch_lua_x",              .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_CONSOLE].x},
    {.name = "touch_lua_y",              .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_CONSOLE].y},
    {.name = "touch_lua_size",           .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_CONSOLE].size},
    {.name = "touch_lua_anchor",         .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_CONSOLE].anchor},
