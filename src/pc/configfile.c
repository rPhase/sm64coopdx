...
#ifdef TOUCH_CONTROLS
    {.name = "touch_stick_x",            .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_STICK].x},
    {.name = "touch_stick_y",            .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_STICK].y},
    {.name = "touch_stick_size",         .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_STICK].size},
    {.name = "touch_stick_anchor",       .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_STICK].anchor},
    {.name = "touch_mouse_x",            .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_MOUSE].x},
    {.name = "touch_mouse_y",            .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_MOUSE].y},
    {.name = "touch_mouse_size",         .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_MOUSE].size},
    {.name = "touch_mouse_anchor",       .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_MOUSE].anchor},
    {.name = "touch_a_x",                .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_A].x},
    {.name = "touch_a_y",                .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_A].y},
    {.name = "touch_a_size",             .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_A].size},
    {.name = "touch_a_anchor",           .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_A].anchor},
    {.name = "touch_b_x",                .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_B].x},
    {.name = "touch_b_y",                .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_B].y},
    {.name = "touch_b_size",             .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_B].size},
    {.name = "touch_b_anchor",           .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_B].anchor},
    {.name = "touch_x_x",                .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_X].x},
    {.name = "touch_x_y",                .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_X].y},
    {.name = "touch_x_size",             .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_X].size},
    {.name = "touch_x_anchor",           .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_X].anchor},
    {.name = "touch_y_x",                .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_Y].x},
    {.name = "touch_y_y",                .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_Y].y},
    {.name = "touch_y_size",             .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_Y].size},
    {.name = "touch_y_anchor",           .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_Y].anchor},
    {.name = "touch_start_x",            .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_START].x},
    {.name = "touch_start_y",            .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_START].y},
    {.name = "touch_start_size",         .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_START].size},
    {.name = "touch_start_anchor",       .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_START].anchor},
    {.name = "touch_l_x",                .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_L].x},
    {.name = "touch_l_y",                .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_L].y},
    {.name = "touch_l_size",             .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_L].size},
    {.name = "touch_l_anchor",           .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_L].anchor},
    {.name = "touch_r_x",                .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_R].x},
    {.name = "touch_r_y",                .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_R].y},
    {.name = "touch_r_size",             .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_R].size},
    {.name = "touch_r_anchor",           .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_R].anchor},
    {.name = "touch_z_x",                .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_Z].x},
    {.name = "touch_z_y",                .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_Z].y},
    {.name = "touch_z_size",             .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_Z].size},
    {.name = "touch_z_anchor",           .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_Z].anchor},
    {.name = "touch_cup_x",              .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_CUP].x},
    {.name = "touch_cup_y",              .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_CUP].y},
    {.name = "touch_cup_size",           .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_CUP].size},
    {.name = "touch_cup_anchor",         .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_CUP].anchor},
    {.name = "touch_cdown_x",            .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_CDOWN].x},
    {.name = "touch_cdown_y",            .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_CDOWN].y},
    {.name = "touch_cdown_size",         .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_CDOWN].size},
    {.name = "touch_cdown_anchor",       .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_CDOWN].anchor},
    {.name = "touch_cleft_x",            .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_CLEFT].x},
    {.name = "touch_cleft_y",            .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_CLEFT].y},
    {.name = "touch_cleft_size",         .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_CLEFT].size},
    {.name = "touch_cleft_anchor",       .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_CLEFT].anchor},
    {.name = "touch_cright_x",           .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_CRIGHT].x},
    {.name = "touch_cright_y",           .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_CRIGHT].y},
    {.name = "touch_cright_size",        .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_CRIGHT].size},
    {.name = "touch_cright_anchor",      .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_CRIGHT].anchor},
    {.name = "touch_chat_x",             .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_CHAT].x},
    {.name = "touch_chat_y",             .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_CHAT].y},
    {.name = "touch_chat_size",          .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_CHAT].size},
    {.name = "touch_chat_anchor",        .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_CHAT].anchor},
    {.name = "touch_playerlist_x",       .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_PLAYERLIST].x},
    {.name = "touch_playerlist_y",       .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_PLAYERLIST].y},
    {.name = "touch_playerlist_size",    .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_PLAYERLIST].size},
    {.name = "touch_playerlist_anchor",  .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_PLAYERLIST].anchor},
    {.name = "touch_dup_x",              .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_DUP].x},
    {.name = "touch_dup_y",              .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_DUP].y},
    {.name = "touch_dup_size",           .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_DUP].size},
    {.name = "touch_dup_anchor",         .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_DUP].anchor},
    {.name = "touch_ddown_x",            .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_DDOWN].x},
    {.name = "touch_ddown_y",            .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_DDOWN].y},
    {.name = "touch_ddown_size",         .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_DDOWN].size},
    {.name = "touch_ddown_anchor",       .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_DDOWN].anchor},
    {.name = "touch_dleft_x",            .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_DLEFT].x},
    {.name = "touch_dleft_y",            .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_DLEFT].y},
    {.name = "touch_dleft_size",         .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_DLEFT].size},
    {.name = "touch_dleft_anchor",       .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_DLEFT].anchor},
    {.name = "touch_dright_x",           .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_DRIGHT].x},
    {.name = "touch_dright_y",           .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_DRIGHT].y},
    {.name = "touch_dright_size",        .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_DRIGHT].size},
    {.name = "touch_dright_anchor",      .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_DRIGHT].anchor},
    {.name = "touch_console_x",          .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_CONSOLE].x},
    {.name = "touch_console_y",          .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_CONSOLE].y},
    {.name = "touch_console_size",       .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_CONSOLE].size},
    {.name = "touch_console_anchor",     .type = CONFIG_TYPE_UINT, .uintValue = &configControlElements[TOUCH_CONSOLE].anchor},
